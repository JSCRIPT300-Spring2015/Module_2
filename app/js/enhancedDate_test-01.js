...
var enhancedDate = function ( ) {
  ...
  return {
    ...
    // getDayName
    getDayName: function(dayNumber) { return dayNames[dayNumber]; },
    dayNumber: function(getDayName) {return dayNames.indexOf(getDayName); }, 
 
    // getMonthName  
    getMonthName: function(monthNumber) { return monthNames[monthNumber]; },
    monthNumber: function(getMonthName) { return monthNames.indexOf(getMonthName); }  
...
console.log(enhancedDate.getDayName(enhancedDate.dayNumber("Sunday")));
// → Sunday
console.log(enhancedDate.getMonthName(enhancedDate.monthNumber("January")));
// → January